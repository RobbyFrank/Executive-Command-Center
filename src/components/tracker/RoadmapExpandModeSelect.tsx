...
function optionForPreset(
  preset: TrackerExpandPreset
): OptionDef {
  const found = OPTIONS.find((o) => o.value === preset);
  ...
  return (
    <div className="relative inline-block max-w-full shrink-0">
      ...
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className={cn(
          "inline-flex max-w-full min-h-[2.25rem] w-max items-center gap-2 rounded-md border border-zinc-700 bg-zinc-900/80 py-1.5 pl-2.5 pr-2 text-sm font-medium transition-colors hover:border-zinc-600 hover:bg-zinc-800 focus:outline-none focus:ring-1 focus:ring-zinc-500",
