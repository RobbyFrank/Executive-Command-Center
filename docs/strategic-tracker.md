...
| Doc | Contents |
| --- | -------- |
| [strategic-tracker-data-model.md](strategic-tracker-data-model.md) | Hierarchy, Companies, Team, Redis storage, uploads |
...
- [data-storage.md](data-storage.md) — Redis key, seed, backup
- [operations.md](operations.md) — CI, cache tags, AI rate limits, PII in prompts
- [roadmap-slack-scrape.md](roadmap-slack-scrape.md) — Scan Slack for suggested goals/projects
- [project-outline.md](project-outline.md) — Strategic framing (goals, prioritization, review cadence)
